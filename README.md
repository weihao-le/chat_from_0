...
milvus数据库需要结合docker（下载docker desktop）使用，可下载官方的配置文件  
   curl -L https://github.com/milvus-io/milvus/releases/download/v2.4.3/milvus-standalone-docker-compose.yml -o docker-compose.ymlcurl -L https://github.com/milvus-io/milvus/releases/download/v2.4.3/milvus-standalone-docker-compose.yml -o docker- composer .yml
